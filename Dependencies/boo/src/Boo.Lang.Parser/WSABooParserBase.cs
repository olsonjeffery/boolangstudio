...
using System.Globalization;
	...
	public 	class WSABooParserBase : antlr.LLkParser
	{
		...
		public const int TRIPLE_QUOTED_STRING = 68;
		public const int EOS = 69;
		public const int NEWLINE = 70;
		public const int DOUBLE_QUOTED_STRING = 71;
		public const int SINGLE_QUOTED_STRING = 72;
		...
		public const int INPLACE_BITWISE_AND = 93;
		public const int INPLACE_SHIFT_LEFT = 94;
		public const int INPLACE_SHIFT_RIGHT = 95;
		public const int CMP_OPERATOR = 96;
		public const int GREATER_THAN = 97;
		public const int LESS_THAN = 98;
		public const int ADD = 99;
		public const int EXCLUSIVE_OR = 100;
		public const int DIVISION = 101;
		public const int MODULUS = 102;
		public const int BITWISE_AND = 103;
		public const int SHIFT_LEFT = 104;
		public const int SHIFT_RIGHT = 105;
		public const int EXPONENTIATION = 106;
		public const int INCREMENT = 107;
		public const int DECREMENT = 108;
		public const int ONES_COMPLEMENT = 109;
		public const int INT = 110;
		public const int LONG = 111;
		public const int RE_LITERAL = 112;
		public const int DOUBLE = 113;
		public const int FLOAT = 114;
		public const int TIMESPAN = 115;
		public const int LINE_CONTINUATION = 116;
		public const int SL_COMMENT = 117;
		public const int ML_COMMENT = 118;
		public const int WS = 119;
		public const int X_RE_LITERAL = 120;
		public const int ESCAPED_EXPRESSION = 121;
		public const int DQS_ESC = 122;
		public const int SQS_ESC = 123;
		public const int SESC = 124;
		public const int RE_CHAR = 125;
		public const int X_RE_CHAR = 126;
		public const int RE_ESC = 127;
		public const int DIGIT_GROUP = 128;
		public const int REVERSE_DIGIT_GROUP = 129;
		public const int ID_PREFIX = 130;
		public const int ID_LETTER = 131;
		public const int DIGIT = 132;
		public const int HEXDIGIT = 133;
		...
		try {      // for error handling
			...
			case NEWLINE:
			{
				{ // ( ... )+
					...
					for (;;)
					{
						if ((LA(1)==EOS||LA(1)==NEWLINE) && (tokenSet_6_.member(LA(2))))
						{
							{
								switch ( LA(1) )
								{
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			{
				if ((LA(1)==TRIPLE_QUOTED_STRING) && (tokenSet_7_.member(LA(2))))
				{
					doc = LT(1);
					...
					{
						if ((LA(1)==EOF||LA(1)==EOS||LA(1)==NEWLINE) && (tokenSet_7_.member(LA(2))))
						{
							eos();
						}
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			{
				if ((LA(1)==EOF||LA(1)==EOS||LA(1)==NEWLINE) && (tokenSet_11_.member(LA(2))))
				{
					eos();
				}
	...
	protected IToken  identifier() //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			{    // ( ... )*
				for (;;)
				{
					if ((LA(1)==DOT) && (tokenSet_17_.member(LA(2))))
					{
						match(DOT);
						id2=member();
						if (0==inputState.guessing)
				...
				{
					{
						...
						else if ((LA(1)==ID) && (LA(2)==OF||LA(2)==LBRACK||LA(2)==LPAREN)) {
						}
						else
						{
							throw new NoViableAltException(LT(1), getFilename());
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			{
				if ((LA(1)==EOF||LA(1)==EOS||LA(1)==NEWLINE) && (tokenSet_34_.member(LA(2))))
				{
					eos();
				}
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			if (((LA(1)==SELF||LA(1)==ID) && (tokenSet_40_.member(LA(2)))))
			{
				int _m125 = mark();
				...
				{
					{
						...
						else if ((LA(1)==SELF||LA(1)==ID) && (tokenSet_41_.member(LA(2)))) {
						}
						else
						{
							throw new NoViableAltException(LT(1), getFilename());
...
_loop135_breakloop:							;
			...
			else if ((LA(1)==ID) && (tokenSet_43_.member(LA(2)))) {
				{
					id2 = LT(1);
					match(ID);
					if (0==inputState.guessing)
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			match(COLON);
			{
				if ((LA(1)==EOF||LA(1)==EOS||LA(1)==NEWLINE) && (tokenSet_49_.member(LA(2))))
				{
					eos();
					docstring(node);
				}
							...
							try {
								{
									{ // ( ... )+
										...
										for (;;)
										{
											...
											{
												if (_cnt488 >= 1) { goto _loop488_breakloop; } else { throw new NoViableAltException(LT(1), getFilename());; }
											}
							...
							{
								{
									{ // ( ... )+
										...
										for (;;)
										{
											...
											{
												if (_cnt493 >= 1) { goto _loop493_breakloop; } else { throw new NoViableAltException(LT(1), getFilename());; }
											}
						...
						try {
							{
								...
								{ // ( ... )+
									...
									for (;;)
									{
										...
										{
											if (_cnt233 >= 1) { goto _loop233_breakloop; } else { throw new NoViableAltException(LT(1), getFilename());; }
										}
...
_loop233_breakloop:									;
					...
					if ( synPredMatched234 )
					{
						...
						if ( synPredMatched238 )
						{
							...
							if (((tokenSet_53_.member(LA(1))) && (tokenSet_65_.member(LA(2)))))
							{
								int _m242 = mark();
							...
							if ( synPredMatched242 )
							{
								...
								else if ((tokenSet_66_.member(LA(1))) && (tokenSet_63_.member(LA(2)))) {
									{
										{
											switch ( LA(1) )
											{
					...
					{
						{
							...
							default:
								...
								else if (((LA(1)==ID) && (tokenSet_77_.member(LA(2))))&&(IsValidMacroArgument(LA(2)))) {
	...
	protected Expression  closure_expression() //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			}
			{
				...
				else if ((tokenSet_81_.member(LA(1))) && (tokenSet_56_.member(LA(2)))) {
				}
				else
				{
					throw new NoViableAltException(LT(1), getFilename());
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			}
			{
				...
				else if ((tokenSet_72_.member(LA(1))) && (tokenSet_85_.member(LA(2)))) {
				}
				else
				{
					throw new NoViableAltException(LT(1), getFilename());
			...
			else if ((tokenSet_14_.member(LA(1))) && (tokenSet_13_.member(LA(2)))) {
				{
					{ // ( ... )+
						...
						for (;;)
						{
							...
							{
								if (_cnt381 >= 1) { goto _loop381_breakloop; } else { throw new NoViableAltException(LT(1), getFilename());; }
							}
								...
								{
									{
										...
										default:
											...
											else if ((LA(1)==IS) && (tokenSet_62_.member(LA(2)))) {
												{
													tis = LT(1);
													match(IS);
													if (0==inputState.guessing)
	...
	protected Expression  exponentiation() //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			{    // ( ... )*
				for (;;)
				{
					if ((LA(1)==EXPONENTIATION) && (tokenSet_62_.member(LA(2))))
					{
						token = LT(1);
	...
	protected Expression  unary_expression() //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			{
				if ((tokenSet_100_.member(LA(1))) && (tokenSet_62_.member(LA(2))))
				{
					{
						{
							switch ( LA(1) )
				...
				else if ((tokenSet_53_.member(LA(1))) && (tokenSet_101_.member(LA(2)))) {
					{
						e=slicing_expression();
						{
							switch ( LA(1) )
		...
		try {      // for error handling
			{
				...
				default:
					if ((LA(1)==SUBTRACT||LA(1)==INT||LA(1)==LONG) && (tokenSet_103_.member(LA(2))))
					{
						e=integer_literal();
					}
					else {
						bool synPredMatched507 = false;
						if (((LA(1)==LBRACE) && (tokenSet_104_.member(LA(2)))))
						{
							int _m507 = mark();
						...
						else if ((LA(1)==LBRACE) && (tokenSet_105_.member(LA(2)))) {
							e=closure_expression();
						}
						else if ((LA(1)==SUBTRACT||LA(1)==DOUBLE||LA(1)==FLOAT) && (tokenSet_106_.member(LA(2)))) {
							e=double_literal();
						}
						else if ((LA(1)==SUBTRACT||LA(1)==TIMESPAN) && (tokenSet_107_.member(LA(2)))) {
							e=timespan_literal();
						}
					else
					{
	...
	protected Expression  paren_expression() //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			else if ((LA(1)==LPAREN) && (tokenSet_55_.member(LA(2)))) {
				{
					lparen = LT(1);
					match(LPAREN);
					e=array_or_expression();
	...
	) //throws RecognitionException, TokenStreamException
{
		...
		try {      // for error handling
			...
			else if ((tokenSet_59_.member(LA(1))) && (tokenSet_109_.member(LA(2)))) {
				{
					value=expression();
					if (0==inputState.guessing)
					{
	...
	protected ExpressionPair  expression_pair() //throws RecognitionException, TokenStreamException
{
	...
	{
		long[] data = { -299519479434249022L, 4494803621025791L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_1_ = new BitSet(mk_tokenSet_1_());
	private static long[] mk_tokenSet_2_()
	{
		long[] data = { -297255172641390910L, 4503599488950271L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_2_ = new BitSet(mk_tokenSet_2_());
	private static long[] mk_tokenSet_3_()
	{
		long[] data = { -297325558565437758L, 4503599488950271L, 0L, 0L};
		return data;
	}
	...
	{
		long[] data = { 1370114736876130432L, 2563L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_5_ = new BitSet(mk_tokenSet_5_());
	private static long[] mk_tokenSet_6_()
	{
		long[] data = { -10308459233598L, 4494803789912063L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_6_ = new BitSet(mk_tokenSet_6_());
	private static long[] mk_tokenSet_7_()
	{
		long[] data = { -290512275846791998L, 4494803755243519L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_7_ = new BitSet(mk_tokenSet_7_());
	private static long[] mk_tokenSet_8_()
	{
		long[] data = { -288230376899346494L, 4503599627370495L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_8_ = new BitSet(mk_tokenSet_8_());
	private static long[] mk_tokenSet_9_()
	{
		long[] data = { -299589848178426686L, 4494803621025791L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_9_ = new BitSet(mk_tokenSet_9_());
	private static long[] mk_tokenSet_10_()
	{
		long[] data = { -299589865358295870L, 4494803621025791L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_10_ = new BitSet(mk_tokenSet_10_());
	private static long[] mk_tokenSet_11_()
	{
		long[] data = { -1669704602234098622L, 4494803621025788L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_11_ = new BitSet(mk_tokenSet_11_());
	private static long[] mk_tokenSet_12_()
	{
		long[] data = { -1669704602234098622L, 4494803621025692L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_12_ = new BitSet(mk_tokenSet_12_());
	private static long[] mk_tokenSet_13_()
	{
		long[] data = { -297325558565765438L, 4503599488819199L, 0L, 0L};
		return data;
	}
	public static readonly BitSet tokenSet_13_ = new BitSet(mk_tokenSet_13_());
	private static long[] mk_tokenSet_14_()
	{
		long[] data = { -1669704602234098624L, 4494803620894620L, 0L, 0L};
		return data;
	}
	...
	{
		long[] data = { 1388129135423033472L, 134219267L, 0L, 0L};
		return data;
	}
	...
	{
		long[] data = { -9223353893836422846L, 168372324L, 0L, 0L};
		return data;
	}
